...
public class DatabaseTask2 extends AsyncTask<String,Void,String > {
    ...
    protected void onPreExecute() {
        ...
        tech_url="http://atmatrisha2015.site40.net/photography.php";
...
*/
        ...
        else if(method.equals("pixelthis")){
