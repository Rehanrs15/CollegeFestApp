 ...
 */
public class DatabaseTask4 extends AsyncTask<String,Void,String > {
    ...
    protected void onPreExecute() {
        ...
        tech_url="http://atmatrisha2015.site40.net/fine_art.php";
    ...
    protected String doInBackground(String... params) {
        ...
        */
        ...
        if(method.equals("body")){
            ...
            String event_name="BODY PAINTING";
